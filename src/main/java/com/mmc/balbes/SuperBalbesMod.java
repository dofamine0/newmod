...
public class SuperBalbesMod
{
    ...
    public SuperBalbesMod(FMLJavaModLoadingContext context)
    {
        ...
        context.registerConfig(ModConfig.Type.COMMON, SuperConfig.SPEC);
    }
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        if (SuperConfig.logDirtBlock)
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(SuperConfig.magicNumberIntroduction + SuperConfig.magicNumber);

        SuperConfig.items.forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
    ...
    public void onServerStarting(ServerStartingEvent event)
    {
        ...
        LOGGER.info("HELLO from server start4ing");
    }
